...
As you see above, if you are using cumulative sets, the single-category sets will always be larger than combinations that contain them. This option makes most sense with mututually exclusive sets:

```{r}
lot_set_percentages(data = data,
                             varnames = c("WASH","Protection","Education","Shelter","Livelihoods"),nintersects = 12,
                             mutually_exclusive_sets = TRUE,
                             exclude_unique = FALSE)
```
